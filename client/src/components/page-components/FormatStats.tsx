...
interface FormatData {
  format: string | null;
  format_wins: number;
  format_losses: number;
  format_ties: number;
  format_played: number;
}
...
const FormatStats: React.FC<FormatStatsProps> = ({
  formatData,
  totalMatches,
}) => {
  ...
  return (
    <div className="w-full mt-4">
      <div
        id="formats"
        className="bg-warmscale-8 rounded-md px-4 py-3 drop-shadow-sm font-cantarell"
      >
