          ...
          <div>
            ...
            <div className="lg:flex justify-between h-5 mt-4 max-lg:mb-10">
              ...
              <div
                ...
                className="flex gap-4 justify-center text-lg font-cantarell font-semibold text-lightscale-4 mr-4"
              >
              ...
              <table className="text-left bg-warmscale-8 bg-opacity-40">
                <thead className="text-base text-tf-orange border-t-2 border-warmscale-8 border-opacity-40 sticky -top-1 z-40 bg-warmscale-8">
                  <tr>
                    ...
                    <th scope="col" className="py-3 px-6">
                      <div>
                        <div className="-mb-1.5 flex">
                          COMBAT <div className="max-lg:hidden"> (CBT)</div>
                        </div>
                        <div className="text-center text-xs text-tf-orange-dark">
                          KILLS
                        </div>
                      </div>
                    </th>
                    <th scope="col" className="py-3 px-6">
                      <div>
                        <div className="-mb-1.5 flex">
                          SUPPORT <div className="max-lg:hidden"> (SPT)</div>
                        </div>
                        <div className="text-center text-xs text-tf-orange-dark">
                          ASSISTS
                        </div>
                    ...
                    <th scope="col" className="py-3 px-6">
                      <div>
                        <div className="-mb-1.5 flex">
                          SURVIVAL <div className="max-lg:hidden"> (SVL)</div>
                        </div>
                        <div className="text-center text-xs text-tf-orange-dark">
                          DEATHS
                        </div>
                    ...
                    <th scope="col" className="py-3 px-6">
                      <div>
                        <div className="-mb-1.5 flex">
                          EFFICIENCY <div className="max-lg:hidden"> (EFF)</div>
                        </div>
                        <div className="text-center text-xs text-tf-orange-dark">
                          KILLS/DEATHS
                        </div>
                    ...
                    <th scope="col" className="py-3 px-6">
                      <div>
                        <div className="-mb-1.5 flex">
                          DAMAGE <div className="max-lg:hidden"> (DMG)</div>
                        </div>
                        <div className="text-center text-xs text-tf-orange-dark">
                          DAMAGE
                        </div>
                    ...
                    <th scope="col" className="py-3 px-6">
                      <div>
                        <div className="-mb-1.5 flex">
                          EVASION <div className="max-lg:hidden"> (EVA)</div>
                        </div>
                        <div className="text-center text-xs text-tf-orange-dark">
                          DTM
                        </div>
                    ...
                    <th
                      scope="col"
                      className="sticky right-0 z-50 py-3 px-6 text-lg bg-warmscale-8"
                    >
                      OVERALL
                    </th>
                  </tr>
                ...
                <tbody className="font-robotomono text-lg  text-lightscale-6 font-semibold">
                  {leaderboardStats.map((playerStats: any, index: number) => {
                    ...
                    if (
                      playerStats.class === currentClassFilter ||
                          ...
                          <td className="flex item-center py-1">
                            ...
                            <div className="flex font-extrabold text-2xl text-lightscale-2 font-robotomono w-48">
                              <div className=" truncate">
                                <a href={`/profile/${playerStats.id64}`}>
                                  {playerStats.rglname}
                                </a>
                              </div>
                            </div>
                          </td>
                          <td className="text-center border-l border-warmscale-8 border-opacity-50">
                            {playerStats.cbt}
                          </td>
                          <td className="text-center border-l border-warmscale-8 border-opacity-50">
                            {playerStats.spt}
