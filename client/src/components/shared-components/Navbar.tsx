...
const Navbar = () => {
  return (
    <div className="flex px-4 flex-wrap justify-between">
      <img className="object-contain" src={moretfWhiteLogo} alt="logo" />
      ...
      <div className="flex justify-center items-center hover:bg-grayscale-9 cursor-pointer p-2 pr-3 -mt-1 rounded-md duration-200">
