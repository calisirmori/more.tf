...
const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`fixed top-20 right-6 z-[9999] flex items-center gap-3 ${typeStyles[type]} border rounded-lg px-4 py-3 shadow-lg backdrop-blur-sm font-cantarell min-w-[300px] max-w-md animate-slide-in-right`}
    >
